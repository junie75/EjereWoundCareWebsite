...
export default function PrivacyNotice() {
  return (
    <Layout>
      <div className="" style={{ margin: "150px 20px 20px 20px" }}>
        <p
          style={{
            marginTop: "0pt",
            marginBottom: "8pt",
        ...
        <ul type="disc" style={{ margin: "0pt", paddingLeft: "0pt" }}>
          ...
          >
            <span style={{ fontFamily: "Arial" }}>Provide disaster relief</span>
          </li>
          <li
            style={{
              marginLeft: "28.52pt",
        ...
        <ul type="disc" style={{ margin: "0pt", paddingLeft: "0pt" }}>
          ...
          >
            <span style={{ fontFamily: "Arial" }}>Bill for your services</span>
          </li>
          <li
            style={{
              marginLeft: "28.52pt",
        ...
        <ul type="disc" style={{ margin: "0pt", paddingLeft: "0pt" }}>
          ...
          >
            <span style={{ fontFamily: "Arial" }}>
              ...
              full, you can ask us not to share that information for the purpose
              of payment or our operations with your health insurer. We will say
        ...
        <p
          style={{ marginTop: "0pt", marginBottom: "10pt", lineHeight: "105%" }}
        >
          <strong>
            <span style={{ fontFamily: "Arial" }}>
          ...
          <span style={{ fontFamily: "Arial" }}>
            ...
            the situations described below, talk to us. Tell us what you want us
        ...
        <p
          style={{ marginTop: "0pt", marginLeft: "18pt", marginBottom: "0pt" }}
        >
          <em>
            <span style={{ fontFamily: "Arial" }}>
        ...
        <p
          style={{ marginTop: "0pt", marginBottom: "10pt", lineHeight: "96%" }}
        >
          <span style={{ fontFamily: "Arial" }}>
